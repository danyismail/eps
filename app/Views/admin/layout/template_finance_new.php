                        ...
                        <div class="nav">
                            ...
                            <!-- <ul id="sidebar_menu">
                                ...
                                <li class="<?=array_search(uri_string(), $arrListMenu) ? 'mm-active' : ''?>">
                                    <a class="d-flex nav-link" href="#" aria-expanded="false">
                                        <i class="far fa-circle m-0"></i> <span>Deposit</span>
                                        <i class="fas fa-chevron-right" style="margin-left: auto;"></i>
                                    </a>
                                    <ul>
                                        <li><a class="nav-link <?=(uri_string() === 'deposit/add') ? 'active' : ''?>"
                                                href="<?=base_url('/deposit/add')?>">Depo SPL</a></li>
                                        <li><a class="nav-link <?=(uri_string() === 'deposit/cek_pending') ? 'active' : ''?>"
                                                href="<?=base_url('/deposit/cek_pending')?>">Cek Pending</a></li>
                                        <li><a class="nav-link <?=(uri_string() === 'deposit/data_transaksi') ? 'active' : ''?>"
                                                href="<?=base_url('/deposit/data_transaksi')?>">Data Transaksi</a></li>
                                        <li><a class="nav-link <?=(uri_string() === 'deposit/cancel') ? 'active' : ''?>"
                                                href="<?=base_url('/deposit/cancel')?>">Cancel Deposit</a></li>
                                    </ul>
                                </li>
                                <li><a class="nav-link d-flex <?=(uri_string() === 'direct') ? 'active-single' : ''?>"
