          ...
          <form action="<?=base_url('/direct/create')?>" method="POST">
            ...
            <div class="form-row mt-1">
              <div class="form-group col-md-6">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="payment_purpose" required></textarea>
              </div>
            </div>
            ...
            <div class="form-row mt-1">
              <div class="form-group col-md-6">
                ...
                <div class="form-check ml-10">
                  <input class="form-check-input" type="radio" name="database" value="da" id="amazone" checked>
